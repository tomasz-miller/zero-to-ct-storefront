...
How to deploy **zero-to-ct-storefront** to production (Vercel recommended). Deployment is a **manual step** — the agent PoC prepares the app and docs; a human runs deploy and configures secrets.
...
## Deploy with commercetools AI plugin (recommended)
