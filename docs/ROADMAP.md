...
**Last updated:** 2026-07-14 (Phase 7 promotions core complete)
...
| Phase 7 — Promotions core | **done** (product discounts on PLP/PDP, discount codes, cart summary) |
...
- **~193 unit tests** (Vitest) + **~27 E2E tests** (Playwright: discovery + cart/checkout + account + wishlist + promotions + API smoke, local with `CTP_*`)
...
2. **Phase 7** — Discount codes + promotion display (P3) — **core done** (mobile drawer planned)
