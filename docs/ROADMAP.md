...
### BFF API endpoints (16 route files)
...
2. **Phase 5** — Order detail + account polish (P2)
3. **Phase 6** — Wishlist (P2)
4. **Phase 7** — Discount codes + promotion display (P3)
5. **Phase 8** — Inventory availability (P3)
6. **Phase 9** — Multi-market (P4, post-PoC)
7. **Phase 10** — Agentic commerce assistant (Future)
...
**Phase 4 slice 2b+2c (done):** Product Search facets (price ranges, `color-label`, `brand` attributes) with URL-driven filters on `/search` and `/category/[slug]`; Search Term Suggestions autocomplete on search form via `/api/search/suggestions` and coss `Autocomplete`; unit + E2E coverage.
